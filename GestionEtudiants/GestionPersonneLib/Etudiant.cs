    ...
    public class Etudiant : IPersonne
    {
        ...
        public List<ITelephone> TelephonePersonnes
        {
            get
            {
                ...
                _telephonePersonnes = phone.TelephonesPersonnes(_matricule);
        ...
        public void Enregistrer(IPersonne personne)
        {
            ...
            using (IDbCommand cmd = ImplementeConnexion.Instance.Conn.CreateCommand())
            {
                ...
                cmd.Parameters.Add(Parametres.Instance.AjouterParametre(cmd, "@matricule", 4, DbType.String, _matricule));
        ...
        public void Supprimer(string matricule)
        {
            ...
            using (IDbCommand cmd = ImplementeConnexion.Instance.Conn.CreateCommand())
            {
                ...
                cmd.Parameters.Add(Parametres.Instance.AjouterParametre(cmd, "@matricule", 4, DbType.Int32, _id));
        ...
        public IPersonne OnePersonne(string matricule)
        {
            IPersonne personne = new Etudiant();
            ...
            using (IDbCommand cmd = ImplementeConnexion.Instance.Conn.CreateCommand())
            {
                ...
                cmd.Parameters.Add(Parametres.Instance.AjouterParametre(cmd, "@matricule", 4, DbType.Int32, matricule));
