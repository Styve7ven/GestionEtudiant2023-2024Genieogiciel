    ...
    public partial class frmPersonne : Form
    {
        ...
        private void btnAdd1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtMatricule.Text = personne.Nouveau().ToString();
        ...
        private void btnSave1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                personne.Matricule = txtName.Text;
        ...
        private void btnDelete1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                personne.Matricule = txtID.Text.ToString();

                personne.Supprimer(personne.Matricule);
        ...
        private void dgvPersonne_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (dgvPersonne.SelectedRows.Count > 0)
                {
                    ...
                    txtMatricule.Text = personne.Matricule.ToString();
                    ...
                    _id_personne = personne.Matricule;
        ...
        private void btnSave2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                telephone.Id_proprietaire = _id_personne;
                ...
                dgvTelephone.DataSource = telephone.TelephonesPersonnes(_id_personne);
            }
            catch (InvalidOperationException ex)
            {
                MessageBox.Show("Error when saving datas, " + ex.Message, "Saving datas", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
